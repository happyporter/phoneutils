...
public class PhoneUtils {
	...
	final public static String DEFAULT_COUNTRY_CODE_NUMERIC= "82";
	final public static String DEFAULT_COUNTRY_CODE_ALPHA2 = "KR";
	...
	public static String normalizeNumber(String number) {
		...
		return normalizeNumber(number, countryCode);
	}
	...
	public static String formatNumberDigitsOnly(String number, PhoneNumberFormat numberFormat) {
		...
		if(PhoneUtils.isValidNumber(number, countryCode)) {
			return formatNumberDigitsOnly(number, countryCode, numberFormat);
		}
	...
	public static String formatNumber(String number, PhoneNumberFormat numberFormat) {
		...
		if(PhoneUtils.isValidNumber(number, countryCode)) {
			return formatNumber(number, countryCode, numberFormat);
		}
		
		return number;
	}
	
	public static String formatNumber(String number, String countryCode, PhoneNumberFormat numberFormat)
	{
	    PhoneNumber phoneNumber = parseNumber(number, countryCode);
	    String fmt = PhoneNumberUtil.getInstance().format(phoneNumber, numberFormat);
	...
	public static String formatNumberDigitsOnly(String number, String countryCode, PhoneNumberFormat numberFormat)
	{
		return PhoneNumberUtil.normalizeDigitsOnly(formatNumber(number, countryCode, numberFormat));
	}
